...
SECRET_KEY = 'django-insecure-h8$)#-$j29=fa-xu9hn58-_&0-99muyj3lm4kv^2)qfrt&)z5e'
...
MONGODB_CLIENT = pymongo.MongoClient(DATABASES['default']['CLIENT']['host'])
DATABASE = MONGODB_CLIENT[DATABASES['default']['NAME']]