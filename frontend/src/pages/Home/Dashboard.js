...
export default function Dashboard() {
  ...
  React.useEffect(() => {
    ...
    const data = {
    "Text": search,
    "Key": "62e1206afed79abbcf2e0230",
    "FromYear": parseInt(year)
}
    axios
      .post("http://0.0.0.0:8080/api/ai/v1/FecthRecordsWithTimeline/", { ...data },{
        "headers":{
      ...
      .then((resp) => {
        ...
        const data = resp.data.ProcessedData;
                ...
                <Grid item xs>
                  <Accordion>
                    <AccordionSummary
                      ...
                      id="panel1a-header"
                    >
                      <Typography>{Object.keys(item)}</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                      <Typography>
