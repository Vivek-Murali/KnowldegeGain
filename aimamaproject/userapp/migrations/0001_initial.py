# Generated by Django 3.2.14 on 2022-07-10 17:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('associations', djongo.models.fields.EmbeddedField(blank=True, model_container=userapp.models.Associations, null=True)),
                ('published', djongo.models.fields.EmbeddedField(blank=True, model_container=userapp.models.Articles, null=True)),
                ('location', models.CharField(max_length=100, null=True)),
                ('liked_article', djongo.models.fields.EmbeddedField(blank=True, model_container=userapp.models.Articles, null=True)),
